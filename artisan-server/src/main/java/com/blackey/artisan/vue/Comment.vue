            ...
            <el-table-column
                    ...
                    width="50">
                        ...
                        <template slot-scope="scope">
                            <el-button v-if="isAuth('admin:comment:update')" type="text" size="small"
                                       @click="addOrUpdateHandle(scope.row.comment)">修改</el-button>
                            <el-button v-if="isAuth('admin:comment:delete')" type="text" size="small"
                                       @click="deleteHandle(scope.row.comment)">删除</el-button>
                        </template>
                    </el-table-column>
