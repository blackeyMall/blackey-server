...
import com.blackey.tenant.global.shiro.JWTToken;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws FilterException {
        ...
        if(StringUtils.isBlank(authorization)){
            throw new FilterException(ResultCodeEnum.UNAUTHORIZED);
        }
     ...
     */
    @Override
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue)throws FilterException {
