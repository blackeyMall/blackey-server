package com.blackey.gen.utils;

import com.blackey.gen.entity.ColumnEntity;
import com.blackey.gen.entity.TableEntity;
...
public class GenUtils {
	...
	public static List<String> getTemplates(String path){
        ...
        templates.add("template/"+path+"/EntityForm.java.vm");
        templates.add("template/"+path+"/EntityBo.java.vm");
		templates.add("template/"+path+"/Dao.java.vm");
		templates.add("template/"+path+"/Dao.xml.vm");
		templates.add("template/"+path+"/Service.java.vm");
	...
	public static void generatorCode(Map<String, String> table,
        ...
        //获取模板列表
		List<String> templates = getTemplates(config.getString("templatesPath"));
	...
	public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("EntityForm.java.vm" )) {
            return packagePath + "dto"+ File.separator+"form" + File.separator + className + "Form.java";
        }
        if (template.contains("EntityBo.java.vm" )) {
            return packagePath + "dto"+ File.separator+"bo" + File.separator + className + "Bo.java";
        }
		...
		if (template.contains("Controller.java.vm" )) {
			return packagePath + "rest" + File.separator + className + "Rest.java";
		}
